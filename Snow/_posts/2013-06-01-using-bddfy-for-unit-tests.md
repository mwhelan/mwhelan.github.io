...
When we started writing unit tests for the [Seleno](http://teststack.net/pages/Seleno.html) project, I thought it would be a good opportunity to try some of these ideas out.
